...
def Startmenu():
    ...
    print("Welcome to THE GAME (Functions Edition)")
    print("")
...
def ageQuestion():
    ...
    if int(age) < int(12):
        print("wow you are VERY young, hmmmm, The priest will like you ;) ")
    elif int(age) < int(18):
        print("a bit young but its ok, the priest likes em young")
    elif int(age) > int(18):
